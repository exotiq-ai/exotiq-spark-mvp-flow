// Drive Exotiq transactional email templates (M6d).
// GENERATED — source of truth: exotiq-rent/docs/rent/emails/source/generate.py
// (edit there, re-bake, regenerate this module; never hand-edit the HTML).
//
// Usage:
//   import { renderEmail } from "../_shared/emailTemplates.ts";
//   const html = renderEmail("payment-approved", { BOOKING_REF: "BK-01234", ... });
//
// renderEmail throws if any {{VARIABLE}} is left unresolved — never send a
// template with visible placeholders. Variable reference:
// exotiq-rent/docs/rent/emails/README.md (also mirrored in each template).
// Rules: always send a text/plain part alongside; never interpolate 1-hour
// signed media URLs (emails outlive the signature).
...
export function renderEmail(name: EmailTemplateName, vars: Record<string, string>): string {
  ...
  if (unresolved) {
    throw new Error("Unresolved email variables: " + [...new Set(unresolved)].join(", "));
  }
  return html;
}
...
`,
  ...
  "receipt-confirmed": `<!DOCTYPE html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
`,
  ...
  "refund-confirmation": `<!DOCTYPE html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
