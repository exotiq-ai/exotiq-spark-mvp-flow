...
export const SUB_PROCESSORS: SubProcessor[] = [
  ...
  {
    name: "Resend",
    purpose: "Transactional email delivery (invites, role changes, signed documents, weekly digests).",
    region: "United States / Global",
    transferMechanism: "SCCs",
  ...
  {
    name: "GoHighLevel",
    purpose: "Primary SMS/CRM platform and A2P 10DLC sender (consent-gated).",
    region: "United States",
    transferMechanism: "SCCs",
  ...
  {
    name: "Twilio",
    purpose: "SMS delivery infrastructure used downstream of GoHighLevel.",
    region: "United States / Global",
    transferMechanism: "SCCs + DPF certified",
